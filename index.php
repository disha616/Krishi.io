	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Modern Education Society's College Of Engineering, Pune<span>Pune 4411001</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9922325701</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">pranavmandani20@gmail.com</a></p>
			</div>
		</div>
